...
profile.set_preference("browser.helperApps.neverAsk.saveToDisk","application/x-msexcel,application/excel,application/x-excel,application/excel,application/x-excel,application/excel,application/vnd.ms-excel,application/x-excel,application/x-msexcel")
profile.set_preference("plugin.disable_full_page_plugin_for_types", "application/x-msexcel,application/excel,application/x-excel,application/excel,application/x-excel,application/excel,application/vnd.ms-excel,application/x-excel,application/x-msexcel")
########################
# Open Web driver
...
while selectclickfail:
    try:
        driver.find_element_by_xpath("//select[@id='geoAssistList']//option[contains(.,'All Counties within " + state + "')]").click()
        selectclickfail = False
    except:
        selectclickfail=True

print("Select all counties in state: "+state)
